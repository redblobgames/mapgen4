...
<div id="diagram-mesh-construction">
  ...
  <p>
  Putting it all together, I have a <span class="hover-term" data-show="all">dual mesh</span>. The same steps work for Voronoi instead of centroid polygons; compare: Centroid&nbsp;<input name="centroidCircumcenterMix" type="range" min="0" max="1" step="0.01" value="0.0"/>&nbsp;Voronoi.
  </p>
</div>
#+end_export
